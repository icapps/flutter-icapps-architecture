...
/// Utility class for displaying a dialog above the current contents of the app.
...
class NativeDialog {
  ...
  ///
  /// Returns a [Future] that resolves to [True] if the primary (affirmative) option was chosen, false for rejection (cancel)
